...
Label(fr2,text=" Airline Booking system ",font=("sitka small",38),compound="center",fg="Orange").pack()
...
def airline():
    ...
    w = OptionMenu(root1, variable, "Delhi", "Kolkata", "Mumbai","U.S.A","Canada","las vegas")
    ...
    w = OptionMenu(root1, variable1, "Delhi", "Kolkata", "Mumbai","U.S.A","Canada","las vegas")
